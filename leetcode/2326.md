...
溫吓書就會記得 $(\cos\theta\_1 + i\sin\theta\_1)(\cos\theta\_2 + i\sin\theta\_2) = \cos(\theta\_1 + \theta\_2) + i\sin(\theta\_1 + \theta\_2)$ 呢條 identity。
...
$(d\_r + d\_c i) \times (-i) = d\_c - d\_r i$ ，所以係 Python 可以好舒服咁寫 `(dr, dc) = (dc, -dr)` 就完成麻煩嘅轉右。
